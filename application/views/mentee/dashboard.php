<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <?php foreach ($data as $row) : ?>
          <?php if ($row->visibility == '2' or $row->visibility == '3') { ?>
            <div style="padding:20px; border-radius:20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.30);">
              ...
              <a href="<?php echo base_url('mentee/event/') . $row->judulPost ?>"> <button type="button" class="btn btn-primary">more info...</button> </a>
  ...
  <!-- /script -->
  <!-- modals -->
  <?php $this->load->view('mentee/dashboard/confirm-modal'); ?>
