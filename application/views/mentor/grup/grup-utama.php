        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <div style="padding:20px; border-radius:20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.30);">
                    <?php foreach ($dt_mentor as $dm) { ?>
                        <form action="<?= base_url('crud_mentor/save_posting') ?>" method="POST">
                        ...
                        <div class="media p-3">
                            ...
                            <div class="media-body">
                                ...
                                <div class="input-komen p-3 text-center">
                                    <form action="<?= base_url('crud_mentor/save_comment/') . $dp->id_grupPost ?>" method="POST">
