                ...
                <div style="padding:20px; border-radius:20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.30);">
                    <table class="table border">
                        <thead class="bg-dark" style="color:white;">
                            <tr>
                                <td>Daftar Kuesioner</td>
                                <td>Status</td>
                                <td>Action</td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($dt_form as $form) { ?>
                                <?php if ($form->visibilitas == '2' or $form->visibilitas == '3') { ?>
                                    <tr>
                                        <td><?php echo $form->judul ?></td>
                                        <td>Belum mengisi</td>
                                        <td><a href="<?php echo base_url($form->link) ?>"><i class="fa fa-play " style="font-size:15px;"></i></a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
